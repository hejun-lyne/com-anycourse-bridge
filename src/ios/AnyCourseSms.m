...
#import "AnyCourseSms.h"

@implementation AnyCourseSms (ModelVersion)
...
@interface AnyCourseSms () {}
@end

@implementation AnyCourseSms
...
- (NSDictionary*)deviceProperties
{
    ...
    [devProps setObject:buildNumber forKey:@"build"];
